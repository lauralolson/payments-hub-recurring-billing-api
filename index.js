...
const epiId = '9001-900300-2-6'; // {String} Merchant's unique 4-part key, which is provided after boarding with the processor
const epiKey = '8EEDC66DF02D7803E05321281FAC8C31'
...
app.post('/signup', async (req, res) => {
    ...
    const ePISignature = crypto.createHmac('sha256', epiKey)
                  .update(concatData)
                  .digest('hex')
